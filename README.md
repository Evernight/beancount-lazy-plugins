...
- **valuation**: Just converts to a `custom "valuation"` entry for the account and amount (see [valuation](#valuation) plugin).
...
; 5) valuation — converts to a `custom "valuation"` entry for the account and amount (see [valuation](#valuation) plugin)
